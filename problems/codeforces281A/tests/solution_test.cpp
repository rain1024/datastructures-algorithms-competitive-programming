...
vector<string> RunProgram(string fileid) {
  vector<string> v;
  string program = "problems/codeforces281A/src/main/solution";
  string test_folder = "problems/codeforces281A/tests/data/";
...
TEST(RunTest, AllTestCases) {
  ...
  std::string test_data_folder = "problems/codeforces281A/tests/data";
