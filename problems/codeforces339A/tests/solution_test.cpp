...
vector<string> RunProgram(string fileid) {
  vector<string> v;
  string program = "problems/codeforces339A/src/main/solution";
  string test_folder = "problems/codeforces339A/tests/data/";
...
TEST(RunTest, AllTestCases) {
  ...
  std::string test_data_folder = "problems/codeforces339A/tests/data";
