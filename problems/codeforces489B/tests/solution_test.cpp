...
vector<string> RunProgram(string fileid) {
  vector<string> v;
  string program = "problems/codeforces489B/src/main/solution";
  string test_folder = "problems/codeforces489B/tests/data/";
...
TEST(RunTest, AllTestCases) {
  ...
  std::string test_data_folder = "problems/codeforces489B/tests/data";
