...
vector<string> RunProgram(string fileid) {
  vector<string> v;
  string program = "problems/aoc2022day1a/src/main/solution";
  string test_folder = "problems/aoc2022day1a/tests/data/";
...
TEST(RunTest, AllTestCases) {
  ...
  std::string test_data_folder = "problems/aoc2022day1a/tests/data";
